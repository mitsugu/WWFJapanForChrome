(function(){
  var region;
  const epThunder='http://www.jma.go.jp/jp/radnowc/imgs/thunder/';
  ...
  function receiveThunder(response){
    var str=response.split('\n',10);
    var fName=str[8].split('\"');
    var url=epThunder+hNowCast[region]+'/'+fName[1];
    document.getElementById('img').setAttribute('src',url);
  }

  function getThunder(){
    chrome.runtime.sendMessage({request:"send thunder.js"},receiveThunder);
  }
